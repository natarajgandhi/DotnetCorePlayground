...
namespace MyAPI.Controllers
{
    ...
    {
        public HotelControllerV2(LinkGenerator linkGenerator, IHotelRepository hotelRepository, ILogger<HotelControllerV2> hotelLogger, IMapper mapper)
        {
        ...
        public ILogger<HotelControllerV2> HotelLogger { get; }
        ...
        public async Task<ActionResult<List<Hotel>>> GetAllHotels(bool includeLocation = true)
        {
            ...
            return Ok("Hello WOrld from version 2 of Hotels!!!!!, see yuu soon!!! Amigo");
        }
